...
RUN wget https://www.apachefriends.org/xampp-files/7.3.15/xampp-linux-x64-7.3.15-0-installer.run
RUN chmod +x xampp-linux-x64-7.3.15-0-installer.run
RUN ./xampp-linux-x64-7.3.15-0-installer.run
RUN rm xampp-linux-x64-7.3.15-0-installer.run
